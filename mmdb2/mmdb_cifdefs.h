...
namespace mmdb  {
  ...
  extern MMDB_DL_IMPORT(cpstr) CIFCAT_PDBX_CHAIN_REMAPPING       ; // GDL: add cif label
  ...
  extern MMDB_DL_IMPORT(cpstr) CIFTAG_ORIG_AUTH_ASYM_ID             ; //GDL: tag for orig_auth_asym_id 
  ...
  extern MMDB_DL_IMPORT(cpstr) CIFTAG_PDBX_SIFTS_XREF_DB_ACC        ; //GDL: adding uniprot tags
  extern MMDB_DL_IMPORT(cpstr) CIFTAG_PDBX_SIFTS_XREF_DB_NUM        ; //GDL: adding uniprot tags
  extern MMDB_DL_IMPORT(cpstr) CIFTAG_PDBX_SIFTS_XREF_DB_NAME        ; //GDL: adding uniprot tags    
  ...
  extern MMDB_DL_IMPORT(cpstr) CIFTAG_REMAP_LABEL_ASYM_ID           ; //GDL:adding tag for label_asym in the remapping
  extern MMDB_DL_IMPORT(cpstr) CIFTAG_ORIG_LABEL_ASYM_ID            ; //GDL: adding tag for orig_label_asym  
  extern MMDB_DL_IMPORT(cpstr) CIFTAG_LABEL_COMP_ID                 ;
  extern MMDB_DL_IMPORT(cpstr) CIFTAG_LABEL_ENTITY_ID               ;
  extern MMDB_DL_IMPORT(cpstr) CIFTAG_REMAP_ENTITY_ID               ; //GDL:Adding tag for entity_id the remapping section
  ...
  extern MMDB_DL_IMPORT(cpstr) CIFTAG_APPLIED_OPERATIONS            ; //GDL: applied operations 
