...
namespace mmdb  {
  ...
  extern cpstr CIFCAT_PDBX_CHAIN_REMAPPING       ; // GDL: add cif label
  ...
  extern cpstr CIFTAG_ORIG_AUTH_ASYM_ID             ; //GDL: tag for orig_auth_asym_id
  extern cpstr CIFTAG_AUTH_ATOM_ID                  ;
  extern cpstr CIFTAG_AUTH_COMP_ID                  ;
  extern cpstr CIFTAG_AUTH_SEQ_ID                   ;
  extern cpstr CIFTAG_PDBX_SIFTS_XREF_DB_ACC        ; //GDL: adding uniprot tags
  extern cpstr CIFTAG_PDBX_SIFTS_XREF_DB_NUM        ; //GDL: adding uniprot tags
  extern cpstr CIFTAG_PDBX_SIFTS_XREF_DB_NAME        ; //GDL: adding uniprot tags
  ...
  extern cpstr CIFTAG_REMAP_LABEL_ASYM_ID           ; //GDL:adding tag for label_asym in the remapping
  extern cpstr CIFTAG_ORIG_LABEL_ASYM_ID            ; //GDL: adding tag for orig_label_asym
  extern cpstr CIFTAG_LABEL_COMP_ID                 ;
  extern cpstr CIFTAG_LABEL_ENTITY_ID               ;
  extern cpstr CIFTAG_REMAP_ENTITY_ID               ; //GDL:Adding tag for entity_id the remapping section
  ...
  extern cpstr CIFTAG_APPLIED_OPERATIONS            ; //GDL: applied operations
